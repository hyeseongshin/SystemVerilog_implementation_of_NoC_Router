...
(
    ...
    (
        ...
        .in_valid(obuf_if.in_valid),
//      .in_ready(obuf_if.in_ready),
        .in_data(obuf_if.in_data),

        .out_valid(obuf_if.out_valid),
        .out_ready(obuf_if.out_ready),
        .out_data(obuf_if.out_data),

        .num_free(obuf_if.num_free)
    );
